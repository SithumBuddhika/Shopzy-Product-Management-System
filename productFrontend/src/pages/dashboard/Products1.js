...
import "./Product.css"; // Ensure CSS file exists
...
// import logoFruit from "../../components/fruit.png";
// import logoMeat from "../../components/meat.png";
// import logoFish from "../../components/seafood.png";
// import logoMilk from "../../components/food.png";
// import logoClean from "../../components/detergent.png";
// import logoSweet from "../../components/cookies.png";
// import logoStaples from "../../components/bread.png";
// import logoSpices from "../../components/spice.png";
// import logoBev from "../../components/alcoholic-drinks.png";
// import logoPersonalC from "../../components/personal-hygiene.png";
// import logoFrozen from "../../components/frozen-goods.png";
// import calendarIcon from "../../components/calender.png";
// import tomatoImg from "../../components/tomato.png";
// import onionpng from "../../components/onions2.png";
// import potatopng from "../../components/potatos.png";
// import leekspng from "../../components/leeks2.png";
// import cabbagepng from "../../components/cabbage.png";
// import carrotpng from "../../components/carrot.png";
// import pumpkingpng from "../../components/pumpking.png";
import bicycleimg from "../../components/bicycle (1).png";

import { listCategories, listProducts, updateProduct, toggleProductAvailability } from "./productService1";
...
const Product = () => {
  ...
  // Fetch products based on the active category using its ID
  useEffect(() => {
    if (!activeCategory) return;
    const fetchProducts = async () => {
      try {
        // Only the category param is passed using the category's ID
        const params = {
  ...
  const handleEditDetails = async () => {
    ...
    try {
      ...
      alert("Error updating product. Please try againn.");
    }
  };
  ...
  return (
    <div className="product-management">
      ...
      <div className="maincontainer">
        ...
        <div className="slider" style={{ transform: activeContainer === "switchcontainer1" ? "translateX(0%)" : "translateX(-50%)" }}>
          ...
          <div className="switchcontainer1" style={{ width: "50%" }}>
            ...
            <div className="category">
              ...
              <div className="heading-toolbar">
                <div className="heading-title">All Products Available At GOCART Store</div>
              ...
              <div className="slots-container">
                {/* Scroll Left Button */}
                <button className="scroll-left" onClick={() => {
                ...
                {/* Scroll Right Button */}
                <button className="scroll-right" onClick={() => {
                  const slots = document.querySelector(".slots");
                  slots.scrollBy({ left: 156, behavior: "smooth" });
                }}>
            ...
            <div className="full_view">
              <div className="changecont">
                ...
                <div className="headingchange-row">
                  <div className="headingchange">{activeCategory ? activeCategory.name : ""}</div>
