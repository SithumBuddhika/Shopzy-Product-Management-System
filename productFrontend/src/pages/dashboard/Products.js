...
const Product = () => {
  ...
  const handleDelete = async (e) => {
    ...
    try {
      ...
      setScards((prev) => prev.filter((card) => card._id !== selectedCard._id));
    ...
    <div className="product-management">
      ...
      <div className="maincontainer">
        ...
        <div className="switch">
          <div
            className={`s1main ${
              activeContainer === "switchcontainer1" ? "active" : ""
            }`}
            onClick={() => {
              setActiveContainer("switchcontainer1");
              navigate("/dashboard-shopowner/productmanagement");
          ...
          <div
            className={`s2main ${
              activeContainer === "switchcontainer2" ? "active" : ""
            }`}
            onClick={() => {
              setActiveContainer("switchcontainer2");
              navigate("/dashboard-shopowner/fleetManagement");
              ...
              <div className="fixedcont">
                {!selectedCard ? (
                  ...
                  >
                    ...
                    >
                      To edit products <br /> Tap on any product
                    </div>
                  </div>
                ) : (
                  <div className="fixedcont-inner">
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Assigned</td>
                    <td>
                      <button type="button" className="see-more-link">
                        see more
                      </button>
                    </td>
                  </tr>
